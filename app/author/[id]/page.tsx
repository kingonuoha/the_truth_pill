...
export default function AuthorProfilePage() {
    ...
    const authorId = params.id as Id<"users">;

    const author = useQuery(api.users.getUserById, { id: authorId });
    const articles = useQuery(api.articles.getByAuthor, { authorId });
                ...
                <div className="flex flex-col md:flex-row gap-10">
                    ...
                    <div className="flex-1 space-y-8">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <p className="text-zinc-500 text-sm font-medium">{articles.length} Results</p>
                        </div>
                        ...
                        {articles.length === 0 ? (
                            ...
                            <div className="grid gap-8">
                                {articles.map((article: JoinedArticle, idx: number) => (
                                    <motion.article
                                        key={article._id}
